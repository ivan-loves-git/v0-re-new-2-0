...
"$pg_bin/createdb" -h 127.0.0.1 -p "$port" w062_rehearsal

cd "$repo_root/scripts"
"$pg_bin/psql" -v ON_ERROR_STOP=1 -h 127.0.0.1 -p "$port" -d w062_rehearsal \
  -f rehearse-ma-interaction-persistence.sql
