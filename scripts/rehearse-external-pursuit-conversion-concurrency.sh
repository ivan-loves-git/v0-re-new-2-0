...
psql_run -c "
  ...
  INSERT INTO public.app_user_roles (user_id,email,role,repreneur_id) VALUES ('w109-race-staff-a','w109-race-staff-a@example.test','staff',NULL),('w109-race-staff-b','w109-race-staff-b@example.test','staff',NULL) ON CONFLICT DO NOTHING;
...
lock="hashtextextended('external-pursuit-conversion:${dossier}', 76098)"
...
echo "W-109 conversion two-client race rehearsal passed: ${dossier} -> ${opportunity}"
