...
DO $$
DECLARE dossier UUID; converted UUID; repeated UUID; opportunity public.opportunities%ROWTYPE; before_matches BIGINT; before_pursuits BIGINT; before_ndas BIGINT;
BEGIN
