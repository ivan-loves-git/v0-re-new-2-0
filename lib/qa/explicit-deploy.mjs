...
export function assertExplicitQaDeploymentReady({
  ...
  if (identity.target === "production" || deployment?.target === "production" || deployment?.productionEnvironment === true) {
...
export function assertSanitizedProviderDeployEvidence(evidence, expected = {}) {
  ...
  if (evidence.target !== "preview") fail("target")
