...
WITH inventory AS (
  ...
  SELECT 'relation', format('%I.%I', n.nspname, c.relname),
         concat_ws('|', c.relkind::text, c.relrowsecurity::text, c.relforcerowsecurity::text, coalesce(c.relacl::text, ''))
  ...
  FROM pg_policies WHERE schemaname IN ('public','qa_control')
  UNION ALL
