...
const serviceRoleBoundaryInventory: Record<string, ServiceRoleExport> = {
  ...
  "lib/actions/opportunity-documents.ts": boundary("staff", ["listOpportunityDocuments", "listPendingUnusedRetainedDocumentCleanups", "registerOpportunityDocument", "updateOpportunityDocumentVisibility", "removeOpportunityDocument", "removeUnusedRetainedOpportunityDocument"]),
