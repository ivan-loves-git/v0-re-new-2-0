...
const serviceRoleBoundaryInventory: Record<string, ServiceRoleExport> = {
  ...
  "lib/actions/staff-portal-external.ts": boundary("staff", ["createSelectedExternalPursuit", "updateSelectedExternalPursuit", "moveSelectedExternalPursuitStage", "saveSelectedExternalPursuitContact", "updateSelectedExternalPursuitFollowUp", "deleteSelectedExternalPursuitAttachment"]),
