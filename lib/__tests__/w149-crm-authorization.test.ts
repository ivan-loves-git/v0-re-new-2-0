...
const serviceRoleBoundaryInventory: Record<string, ServiceRoleExport> = {
  ...
  "app/(dashboard)/portal-preview/deals/[matchId]/nda-template/route.ts": boundary("staff", ["GET"]),
  "app/(dashboard)/portal-preview/page.tsx": boundary("staff", ["default"]),
  ...
  "app/api/strategic-pdr/attachments/[attachmentId]/route.ts": boundary("staff", ["GET"]),
  ...
  "lib/actions/opportunity-documents.ts": boundary("staff", ["listOpportunityDocuments", "listPendingUnusedRetainedDocumentCleanups", "registerOpportunityDocument", "updateOpportunityDocumentVisibility", "removeOpportunityDocument", "removeUnusedRetainedOpportunityDocument", "setOpportunityRecipientImRequired", "retryRecipientImCleanup"]),
  ...
  "lib/actions/staff-email-review.ts": boundary("staff", ["listStaffEmailReviews", "getStaffEmailReview", "prepareMaEmailReview", "preparePursuitEmailReview", "editStaffEmailReview", "cancelStaffEmailReview", "approveAndSendStaffEmailReview"]),
  "lib/actions/repreneur-portal-preview.ts": boundary("staff", ["listStaffPortalPreviewOptions", "listStaffPortalPreviewExternalPursuits", "getStaffPortalPreviewProfile"]),
  ...
  "lib/actions/staff-portal-assistance.ts": boundary("staff", ["recordStaffPortalOpportunityResponse"]),
  "lib/actions/staff-portal-external.ts": boundary("staff", ["createSelectedExternalPursuit", "updateSelectedExternalPursuit", "moveSelectedExternalPursuitStage", "saveSelectedExternalPursuitContact", "updateSelectedExternalPursuitFollowUp", "confirmSelectedExternalPursuitCurrent"]),
  "lib/actions/staff-portal-workspace.ts": boundary("staff", ["selectStaffPortalWorkspace"]),
  "lib/actions/strategic-pdr.ts": boundary("staff", ["submitStrategicPdrRequest", "dispositionStrategicPdrRequest", "saveStrategicPdrScreening"]),
