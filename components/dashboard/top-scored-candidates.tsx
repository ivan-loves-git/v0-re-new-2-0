...
interface TopScoredCandidatesProps {
  candidates: TopCandidate[]
}

export function TopScoredCandidates({ candidates }: TopScoredCandidatesProps) {
          ...
          {candidates.length > 0 ? (
            candidates.slice(0, 5).map((candidate, index) => (
              ...
              >
                ...
                <div className={`px-2 py-1 rounded-md text-sm font-bold ${getScoreColor(candidate.overall_score)}`}>
