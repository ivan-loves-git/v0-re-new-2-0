    ...
    <div className={cn("space-y-6", className)}>
      {step.questions.map((question) => {
        ...
        if (step.id === 1 && question.id === "first_name") {
          ...
          return (
            <div key="name-group" className="wave-panel p-8">
        ...
        if (step.id === 1 && question.id === "phone") {
          ...
          return (
            <div key="contact-group" className="wave-panel p-8">
              <div className="grid sm:grid-cols-2 gap-4">
                <QuestionRenderer
                  question={question}
                  formData={formData}
        ...
        if (question.id === "marketing_consent") {
          return (
            <div key={question.id} className="wave-semantic-panel p-6">
              <QuestionRenderer
                question={question}
                formData={formData}
                handlers={handlers}
        ...
        return (
          <div key={question.id} className="wave-panel p-6">
            <QuestionRenderer
              question={question}
              formData={formData}
              handlers={handlers}
