...
BEGIN
  ...
  END LOOP;
  FOR item IN SELECT schemaname, tablename, policyname FROM pg_policies WHERE schemaname = 'public' AND roles && ARRAY['public'::name, 'anon'::name, 'authenticated'::name] LOOP
