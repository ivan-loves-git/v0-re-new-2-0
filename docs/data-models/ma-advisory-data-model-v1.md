...
| E4 — qualification and blank-NDA request | System/staff; E4 fires on every mutual-interest validation | Store the E4 transition, delivery result and idempotency reference; “E4 sent” is computed | E4 always requests intermediary qualification and requests the opportunity-level blank NDA only when the opportunity does not already hold it; delivery evidence and idempotency are mandatory | Staff only | Retain each validation and delivery result; append E4 transition event without creating duplicate external requests |
...
| --- | --- | --- | --- |
| 2026-07-27 | 2.0 | Added the authoritative W-001 action-and-evidence matrix: staff/repreneur authority, exact E4/E6/E7/E8 and Gate 1/Gate 2 sequencing, source-disclosure conditions, lifecycle evidence/retention rules, and the shared Acme provisional-source correction and cutover-blocking rule. This documentation release introduces no migration or new user-facing capability. | W-001; W-021 decision; future Acme and W-010 implementation cards |
