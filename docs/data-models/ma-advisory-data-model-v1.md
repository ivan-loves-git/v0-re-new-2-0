...
| --- | --- | --- | --- |
| 2026-08-08 | 4.5.2 | Added the checked-in W-083 through W-087 application candidate: dedicated staff M&A navigation; bulk-derived firm and office indicators; deterministic Manual/System-recorded activity provenance; and firm/office workspaces over canonical offices, affiliations, opportunities and `ma_interactions`. A staff-gated notes action retains actor/time evidence, while the released W-082 office-creation and canonical contact-affiliation services remain authoritative. No aggregate, firm-owned relationship, second activity ledger, schema change or repreneur visibility is introduced. | W-083, W-084, W-085, W-086 and W-087 implementation candidate |
