...
5. Migration 082 performs no legacy backfill. `opportunity_matches.nda_status`, `nda_document_id` and related timestamps remain compatibility fields and never become canonical artifact evidence by inference.
