...
| Implementation status | Migrations 076 to 089 are live and schema-verified. W-010 activated Colin's approved 28 July workbook in production on 2026-07-28: WAVE is now the sole operational record for the imported snapshot and Excel is read-only evidence. The activation reconciled 148 opportunity references, 229 firms, 431 offices, 575 named contacts and 603 active affiliations; temporary staging was purged and the retained manifest contains only approved aggregate evidence. The canonical office/contact model, W-064 provisional Acme foundation, W-062 interaction persistence, W-066 staff Relationships workspace, W-043 staff-only NDA artifact foundation, W-069 permanently staff-only source-teaser retention, W-072 purpose-aware email suppression and the complete opportunity-to-memo journey are live. Migration 090 is a checked-in candidate: it permits DOCX only for an opportunity-level blank NDA template, while signed copies, source teasers and IMs remain PDF-only. W-071 post-cutover reconciliation remains approved target behavior and is not yet implemented. |
...
| --- | --- | --- | --- |
| 2026-08-08 | 4.5.0 | Added the checked-in migration 090 candidate: staff may retain an opportunity-level blank NDA template as either PDF or DOCX, and the active repreneur downloads the exact Gate-1-bound version. Staff and portal paths remain download-only for DOCX. Re-New and repreneur signed copies, source teasers and Information Memoranda remain PDF-only; no editing, conversion or signing capability is added. | W-089 approved document-format extension; migration 090 candidate |
