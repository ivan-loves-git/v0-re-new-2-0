...
10. A thrown or otherwise ambiguous provider outcome remains `pending`, keeps the short-lived source-office send reservation, blocks a retry, and requires reconciliation. It is never guessed to be sent or failed.
