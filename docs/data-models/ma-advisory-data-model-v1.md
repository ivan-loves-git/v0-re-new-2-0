...
25. W-070 gates only automatic unassigned deal-flow discovery, not a staff-proposed match, pursuit history or staff matching tools. Automatic discovery requires a canonical-or-supported-legacy geography selection, a canonical-or-supported-legacy sector selection, and at least one detailed numeric target: a revenue bound, minimum EBITDA margin or headcount bound. WHO, WHEN, scoring flags and the broad deal-size answer do not satisfy or block this gate. While the acquisition project is incomplete, the repreneur sees staff-selected opportunities; direct access to an otherwise unassigned deal returns no deal.
