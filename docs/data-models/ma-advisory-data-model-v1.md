...
| --- | --- | --- | --- |
| 2026-08-27 | 4.5.33 candidate | Approved W-164 as the successor to W-021's manual publication rule. Lifecycle controls same-namespace discovery; compatibility exposure is derived; incomplete reader fields are warnings; incomplete thesis receives neutral inventory; REAL and DEMO permit only equal-namespace reads and actions. Historical cross-namespace matches stay frozen audit evidence and are excluded from portals and production operations. The guarded migration reconciles every current lifecycle mismatch through a fresh exact manifest without duplicating W-021 events. | W-164; `opportunity-discovery-namespace-contract-v1.md`; migration `20260827103000_w164_lifecycle_namespace_visibility.sql` |
