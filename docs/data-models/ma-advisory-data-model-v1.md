...
| --- | --- | --- | --- |
| 2026-08-29 | 4.5.38 candidate | Scoped W-169's internal Pause transition flag to the exact guarded update. A dedicated Pause call now restores the caller's prior flag before it appends history, so a direct service transaction cannot inherit authority and pause a second opportunity. The full-schema rehearsal proves the post-service bypass remains rejected. | W-169; migration `20260829203000_w169_pause_guard_scope.sql`; GitHub Product Change #19 and Ticket #22 |
