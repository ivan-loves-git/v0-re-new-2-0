...
| --- | --- | --- | --- |
| 2026-08-29 | 4.5.36 candidate | Added the W-161 Matching 2.1 scoring candidate: sector and canonical geography are hard eligibility checks; revenue, absolute EBITDA, EBITDA margin and headcount use the approved 36/29/21/14 deterministic rules. Buyer-undefined criteria are omitted, missing targeted evidence is capped review, and same-namespace refresh writes only platform score fields. Matching 2.0 remains the live production calibration until this candidate is separately released. | W-161 Ticket #13 candidate |
| 2026-08-29 | 4.5.35 candidate | Added the W-161 candidate optional absolute EBITDA target range to the canonical repreneur thesis. The additive migration has no default, inference or backfill; both nullable kEUR bounds validate non-negative finite values and range order. Intake, shared staff/portal editing and read projections preserve one-sided or blank ranges. | W-161 Ticket #12 candidate; migration `20260829130000_w161_repreneur_target_ebitda_range.sql` |
