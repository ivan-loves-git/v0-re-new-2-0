...
| Last reviewed against live Supabase | 2026-08-25, including the W-157 active-contact affiliation preflight |
...
### W-157 single-office contact boundary (approved implementation candidate)
...
| --- | --- | --- | --- |
| 2026-08-25 | 4.5.29 candidate | Replaced the earlier multiple-current-office contact model with exactly one active office affiliation per active contact. The evidence-first migration end-dates surplus affiliations without deleting history and fails closed for a losing non-terminal opportunity link. A unique partial index plus deferred contact/affiliation invariants enforce one current office; existing-person affiliation creation rejects a second office. Staff can atomically correct approved contact fields and placement, while read-only linked opportunities retain primary context and Draft, Active or Paused links block movement. | W-157 implementation candidate |
