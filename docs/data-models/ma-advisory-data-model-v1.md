...
| `ma_interactions`, `ma_interaction_owner_verification_events`, `ma_interaction_delivery_events`, `ma_interaction_legacy_migration_manifest` | Migration 080 provides staff-only canonical history, append-only owner and delivery evidence, controlled begin/finalize/owner-verification services, and content-free before/after digests; direct service-role table mutation is denied | Keep attachments and general interaction create/edit UI deferred to W-066 | W-062 live and production-verified |
