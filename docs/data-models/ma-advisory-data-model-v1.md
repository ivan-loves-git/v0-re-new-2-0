...
| --- | --- | --- | --- |
| 2026-08-29 | 4.5.34 candidate | Added the W-161 candidate optional absolute EBITDA target range to the canonical repreneur thesis. The additive migration has no default, inference or backfill; both nullable kEUR bounds validate non-negative finite values and range order. Intake, shared staff/portal editing and read projections preserve one-sided or blank ranges. It is a detailed completeness signal only: no Deal Flow access or human state changes, and no Matching 2.1 scoring change. | W-161 Ticket #12 candidate; migration `20260829130000_w161_repreneur_target_ebitda_range.sql` |
